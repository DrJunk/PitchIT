...
public class Database {
    ...
    {
        HttpHandler.addRequest("get_new_ideas");
    }

    public static void PostRefreshTrending()
    {
        HttpHandler.addRequest("get_trending_ideas");
    }

    public static void PostRefreshHot()
    {
        HttpHandler.addRequest("get_hot_ideas");
    }

    public static void RefreshNews(IdeaData[] data)
    {
        news = data;
        MyPitch.mHandler.obtainMessage(0, 0).sendToTarget();
    }

    public static void RefreshTrending(IdeaData[] data)
    {
        trending = data;
        MyPitch.mHandler.obtainMessage(0, 1).sendToTarget();
    }

    public static void RefreshHot(IdeaData[] data)
    {
        hot = data;
        MyPitch.mHandler.obtainMessage(0, 2).sendToTarget();
    }
    ...
    {
        Request req = new Request("add_up_vote");
    ...
    {
        Request req = new Request("remove_up_vote");
        req.put("id", String.valueOf(ideaId));
        HttpHandler.addRequest(req);
    }
    ...
    {
        Request req = new Request("add_on_it_vote");
        req.put("id", String.valueOf(ideaId));
        HttpHandler.addRequest(req);
    }
    ...
    {
        Request req = new Request("remove_on_it_vote");
        req.put("id", String.valueOf(ideaId));
        HttpHandler.addRequest(req);
    }
}